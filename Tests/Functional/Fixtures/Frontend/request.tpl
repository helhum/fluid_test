...
class Helhum_TYPO3_FluidTest_RequestBootstrap
{
    /**
     * @return void
     */
...
Helhum_TYPO3_FluidTest_RequestBootstrap::setGlobalVariables({arguments});
Helhum_TYPO3_FluidTest_RequestBootstrap::executeAndOutput();
